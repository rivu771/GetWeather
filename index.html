...
body {
    ...
    background: #222;
    background-image: url('https://source.unsplash.com/1600x900/?q=<?php $city ?>');
    font-size: 120%;
  }
...
<body>
  ...
  <div class="card">
    <div class="search">
      ...
      <button name="submit"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1.5em"
