...
<?php
 $city="";
     $city=$_POST['city'];
     $url="api.openweathermap.org/data/2.5/weather?q=$city&appid=32287959de9dc6aae8570bed291f7d8e";
    $ch=curl_init();
...
<body>
  ...
  <div class="card">
    <div class="search">
      ...
      <button name="submit" value="submit" type="Submit"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1.5em"
